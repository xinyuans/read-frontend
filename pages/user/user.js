...
Page({
  data: {
    ...
    emails: [
      {
        id: '12312312311231',
        bgImgUrl: 'http://127.0.0.1:9090/myapp/email_bg01.jpg',
        digest: {
          author_img: 'http://127.0.0.1:9090/myapp/user/personal.png',
          author_name: '熊猫老师',
          author_des: '宣传部',
          title: "“阅读推行赠书计划”已经开始",
          content: {
      ...
      allTasks: [
        {
          ...
          img: 'http://127.0.0.1:9090/myapp/dazhuzai.jpg',
          bookName: '大主宰',
        ...
        {
          bookId: '1231231231',
          img: 'http://127.0.0.1:9090/myapp/chenyuan.jpg',
          bookName: '尘缘',
  ...
  headimgError: function () {
    this.setData({avatar: 'http://127.0.0.1:9090/myApp/unknown_headimg.png?imageView2/1/w/60/h/60/format/jpg/interlace/1/q/75|imageslim'});
  }
})